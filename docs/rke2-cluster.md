...
KSM 強化 + worker1 swap 投入の詳細は [docs/proxmox-zabbix-monitoring.md](proxmox-zabbix-monitoring.md) を参照。PVE host available が回復したため、同日中に memory hotplug で cp1/worker1 を増。Phase 0 → Phase B で現状 **7c / 20 GiB**:
