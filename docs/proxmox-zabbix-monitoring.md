...
| 監視対象 (Linux agent, VM) | 100, 110, 120, 150 | VM | (各 IP) | openmediaVault (2026-05-18 Phase 1 追加), k8s-cp1, k8s-worker1 (Phase 4-D 追加), admin-vm (2026-05-19 追加、hostid=10704) |
...
| 監視対象外 | 102, 191 | LXC | — | puter / ntfy は Zabbix host 未登録 (PVE LLD の discovered items のみ)。mail (LXC 101) は stopped |
