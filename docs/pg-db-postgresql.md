...
[memory: proxmox-zabbix](../../.claude/projects/-home-shotayagami/memory/proxmox_zabbix_monitoring.md) の運用ルール通り、`Linux: Load average is too high` (triggerid=27732) は LXC では `/proc/loadavg` をホストと共有するため誤発火源 → **disable 済**。
